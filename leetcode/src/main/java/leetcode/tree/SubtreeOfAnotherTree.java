...
public class SubtreeOfAnotherTree {
    ...
    public boolean isSubtree_3r(TreeNode root, TreeNode subRoot) {
        if(root == null && subRoot == null)
            return true;
        ...
        if (isSameTree_3r(root, subRoot))
            return true;
        
        return isSubtree_3r(root.left, subRoot) || isSubtree_3r(root.right, subRoot);
    }
    
    private boolean isSameTree_3r (TreeNode node1, TreeNode node2) {
        if (node1 == null && node2 == null)
            return true;
        ...
        return node1.val == node2.val && isSameTree_3r(node1.left, node2.left) && isSameTree_3r(node1.right, node2.right);
